...
{
    /// <summary>
    /// CustomerIndexationDetailSummary
    /// </summary>
    public class CustomerIndexationDetailSummary
    {
        public CustomerIndexationDetailSummary()
        { }

        public CustomerIndexationDetailSummary(ICustomerIndexationDetailSummary data)
        {
        ...
        public CustomerIndexationDetailSummary(int indexationid, decimal indexationFactor, string indexationtype, DateTime appliesFrom, DateTime created, string createdBy, string notes)
        {
