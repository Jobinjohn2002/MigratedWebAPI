...
{
    /// <summary>
    /// OmniSearchInstanceDetail
    /// </summary>
    public class OmniSearchInstanceDetail
    {
        public OmniSearchInstanceDetail()
        { }
        ...
        public OmniSearchInstanceDetail(
                                      ...
                                      string legacyExternalId,
                                      string externalId,
                                      string superType, bool isArchived)
        {
            InstanceId = instanceUid;
            DeliveryPoint = deliveryPoint;
            CustomerStatusId = customerStatusId;
        ...
        public OmniSearchInstanceDetail(int instanceUid,string name,                                       
                                        string deliveryPoint,
                                        string customer,
                                        long? legacyInternalId,
                                        string legacyExternalId,
                                        ...
                                        string serviceRequirement)
        {
            ...
            TurnaroundCount = tunrnaroundCount;
