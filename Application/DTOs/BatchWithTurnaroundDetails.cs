...
{
    /// <summary>
    /// BatchWithTurnaroundDetails
    /// </summary>
    public class BatchWithTurnaroundDetails
    {
        public BatchWithTurnaroundDetails()
        { }

        public BatchWithTurnaroundDetails(IBatch batch, int itemsPassed, int itemsFailed, DateTime firstItemPassed)
        {
            Batch = batch;
