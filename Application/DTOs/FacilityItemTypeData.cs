...
{   
	public sealed partial class FacilityItemTypeData 
	{
        public FacilityItemTypeData() { }
		public FacilityItemTypeData(short facilityId, short itemTypeId, string itemTypeName)
		{
