...
namespace SynergyApplicationFrameworkApi.Application.DTOs
{
    ...
    public class InvoiceSummaryData
    {
		public InvoiceSummaryData(
			int currentCustomerInvoiceCount,
			int currentCustomerGroupInvoiceCount,
			int currentDirectorateInvoiceCount)
        {
			CurrentCustomerInvoiceCount = currentCustomerInvoiceCount;
			CurrentCustomerGroupInvoiceCount = currentCustomerGroupInvoiceCount;
			CurrentDirectorateInvoiceCount = currentDirectorateInvoiceCount;
        }
		/// <summary>
